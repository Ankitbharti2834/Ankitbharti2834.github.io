...
const CONFIG = {
  ...
  certifications: [
    ...
    },
    {
      ...
      issuer: "Project Management Institute, Inc.",
      status: "Completed",
      icon: "PMI",
  ...
  competitions: [
    {
      ...
      organizer: "Department of Industrial and Management Engineering (DIME), Indian Institute of Technology (IIT), Kanpur",
      result: "Participant",
      date: "2021",
    ...
    },
    {
      ...
      organizer: " sponsored by  Niti  Aayog (Govt. of India)",
      result: "Participant",
      date: "2020",
    ...
    },
    {
      ...
      organizer: "Indian Institute of Management (IIM), Rohtak",
      result: "Participant",
      date: "2021",
